    ...
    def evaluate_data_for_one_epochs(
        ...
        for batch in validation_dataloader:
            ...
            with torch.no_grad():
                ...
                # https://huggingface.co/transformers/v2.2.0/model_doc/DistilBert.html#transformers.DistilBertForSequenceClassification
                outputs = model(
...
def load_sentences_and_labels():
    ...
    # !tar cvf hinglishDistilBertClass.tar hinglishDistilBertClass/

    # !cp hinglishDistilBertClass.tar ../drive/My\ Drive/HinglishNLP/Models/Class
    # !cp DistilBertpreds.csv ../drive/My\ Drive/HinglishNLP/PredOutput/
